...
export default async function Page(){
 ...
 if(results.some(result=>result.error))return <main className="cms-auth"><h1>CRM pendiente de conexión</h1><p>No fue posible cargar los registros. Verifica la migración CRM y tu conexión.</p><a href="/admin">Volver al CMS</a></main>;
