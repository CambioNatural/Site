    ...
    <div className="bg-[#f4e509] flex flex-col overflow-x-hidden">
      ...
      <main className="hidden md:block">
        ...
        <div className="relative" style={{ width: 1440, height: 4018 }}>
          ...
          <p className="absolute font-[family-name:var(--font-body)] text-[18px] text-black text-center leading-[1.216]" style={{ left: 759, top: 2227, width: 377 }}>
            Powered by{" "}<a href="https://www.are.na/" target="_blank" rel="noopener noreferrer" className="underline hover:opacity-70">Are.na</a>
          </p>
          ...
          <p className="absolute font-[family-name:var(--font-body)] text-[18px] text-black text-center leading-[1.216]" style={{ left: 752, top: 3300, width: 377 }}>
            Powered by{" "}<a href="https://www.are.na/" target="_blank" rel="noopener noreferrer" className="underline hover:opacity-70">Are.na</a>
          </p>
